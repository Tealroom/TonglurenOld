package com.wanlichangmeng.tonglurendesign.widget.chat;
...
import com.wanlichangmeng.tonglurendesign.utils.chat.AudioRecoderUtils;
import com.wanlichangmeng.tonglurendesign.utils.chat.PopupWindowFactory;
    ...
    public EmotionInputDetector build() {
        ...
        mAudioRecoderUtils.setOnAudioStatusUpdateListener(new AudioRecoderUtils.OnAudioStatusUpdateListener() {
            ...
            public void onUpdate(double db, long time) {
                ...
                mTextView.setText(UIUtils.long2String(time));
            }

            //录音结束，filePath为保存路径
            @Override
            public void onStop(long time, String filePath) {
                mTextView.setText(UIUtils.long2String(0));
                MessageInfo messageInfo = new MessageInfo();
