...
import com.wanlichangmeng.tonglurendesign.adapter.chat.EmotionGridViewAdapter;
import com.wanlichangmeng.tonglurendesign.adapter.chat.EmotionPagerAdapter;
import com.wanlichangmeng.tonglurendesign.base.BaseFragment;
...
import com.wanlichangmeng.tonglurendesign.widget.chat.IndicatorView;
...
public class ChatEmotionFragment extends BaseFragment {
    ...
    private void initEmotion() {
        ...
        // item的间距
        int spacing = UIUtils.dp2px(getActivity(), 12);
        // 动态计算item的宽度和高度
