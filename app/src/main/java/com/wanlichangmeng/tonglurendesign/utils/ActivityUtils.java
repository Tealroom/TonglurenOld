...
public class ActivityUtils {
     ...
     */
    @TargetApi(19)
    public static void transparencyBar(Activity activity, LinearLayout linear_bar){
...
//            linear_bar.setBackground(fragment.getActivity().getDrawable(android.R.drawable.bottom_bar));
            ...
            StatusBarLightMode(activity);//设置状态栏字体颜色
...
//            fragment.getActivity().getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
...
//                    | View.SYSTEM_UI_FLAG_LAYOUT_STABLE);
            ...
            //fragment.getActivity().getWindow().setNavigationBarColor(Color.TRANSPARENT); //设置navigationbar颜色为透明
...
//                    | View.SYSTEM_UI_FLAG_LAYOUT_STABLE);
            ...
            fragment.getActivity().getWindow().setStatusBarColor(Color.TRANSPARENT);

            StatusBarLightMode(fragment.getActivity());//设置状态栏字体颜色
