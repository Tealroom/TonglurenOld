...
public class Camera2Helper {
    ...
    private final CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(@NonNull CameraDevice cameraDevice) {
            //Log.e("nihaome","wohenhaowocaonime");
        ...
        public void onDisconnected(@NonNull CameraDevice cameraDevice) {
            //Log.e("nihaome","wohenhaowohenhaowohenhaowohenhaowohenhaowohenhao");
            mCameraOpenCloseLock.release();

            cameraDevice.close();
            //Log.e("nihaome","wohenhao");
            mCameraDevice = null;
        }
    ...
    private CameraCaptureSession.CaptureCallback mCaptureCallback = new CameraCaptureSession.CaptureCallback() {
        ...
        public void onCaptureProgressed(@NonNull CameraCaptureSession session,
            ...
            Log.e("wrong","onCaptureProgressed");
        }
    ...
    private Camera2Helper(CameraActivity act, AutoFitTextureView view) {
    }

    private Camera2Helper(CameraActivity act, AutoFitTextureView view, File file) {
        activity = act;
        textureView = view;
        mFile = file;
        manager = (CameraManager) activity.getSystemService(Context.CAMERA_SERVICE);
    }
    private Camera2Helper(CameraActivity act, Fragment ft, AutoFitTextureView view, File file) {
        activity = act;
        fragment = ft;
        textureView = view;
        mFile = file;
    ...
    public static Camera2Helper getInstance(CameraActivity act, AutoFitTextureView view, File file) {
        if (singleton == null) {
            synchronized (Camera2Helper.class) {
                singleton = new Camera2Helper(act, view, file);
            }
        }else{
                singleton.setTextureView(view);
            ...
            public void run() {
                if (textureView != null) {
                    if (textureView.isAvailable()) {
                        //Log.e("yes","hahahahahahhhahahahah");
                        openCamera(textureView.getWidth(), textureView.getHeight());
                    } else {
                        //Log.e("no","hahahahahahhhahahahah");
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback = new CameraCaptureSession.CaptureCallback() {
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull TotalCaptureResult result) {
                    ...
                    activity.afterTakePicture();
                    Log.e("wrong","onCaptureCompleted" + "保存照片成功");
                }
            };
...
//            new TakePictrueFragment.ConfirmationDialog().show(fragment.getChildFragmentManager(), "dialog");
//        } else {
...
//                    width, height, mVideoSize);
            ...
            //Log.e("wocaonima","I am here1");
            if (!mCameraOpenCloseLock.tryAcquire(2500, TimeUnit.MILLISECONDS)) {
                Log.e("wocaonima","I am here2");
                throw new RuntimeException("Time out waiting to lock camera opening.");
            }
            if (ActivityCompat.checkSelfPermission(activity, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                Log.e("wocaonima","I am here3 "+ActivityCompat.checkSelfPermission(activity, Manifest.permission.CAMERA));
                /**
                 *
                 *
                 *
                 ...
                 *
                 *
                 * 申请权限不应该放在这里，应该放在ACTIVITY里面最好是程序一开始的时候就申请的东西
                 *
                 *
                 *
                 *
...
//                            mIsRecordingVideo = true;
    ...
    public String stopRecordingVideo() {
        ...
        if (null != activity) {
            ...
            Log.d("服，在helper", "Video saved: " + mNextVideoAbsolutePath);
        }


        /**本来完了应该循环录制就应该调用下面的函数的*/
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        if (mNextVideoAbsolutePath == null || mNextVideoAbsolutePath.isEmpty()) {
            ...
            Log.e("goushidizhi",mNextVideoAbsolutePath);
        }
    ...
    private static Size chooseVideoSize(Size[] choices) {
        ...
        Log.e("服，在helper", "Couldn't find any suitable video size");
